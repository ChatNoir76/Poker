...
public class CanvasIHM 
{
  ...
  **/
  ...
  /**
     ...
     @param actions un objet qui implémente l'interface ControlesCanvasIHM
  */
  ...
  */
  ...
  /** Ajout d'un polygone p1,p2,....  et de couleur.
      @param objet objet quelconque (utilisé dans pointerCanvas)
      @param position position de l'objet en (x,y,z)
      @param couleur couleur (valeur de 1 à 10)
  ...
  */
  ...
  /** Ajout d'un polygone p1,p2,....  et de couleur.
      ...
      @param o objet quelconque (utilisé dans pointerCanvas)
  ...
  */
  ...
  /** Methode static qui permet de creer le canvas inclus dans un Frame
      ...
      @return retourne le canvas créé
  */
